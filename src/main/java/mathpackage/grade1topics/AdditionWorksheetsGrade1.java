...
public class AdditionWorksheetsGrade1 extends WorksheetTemplate implements Serializable{
    ...
    public AdditionWorksheetsGrade1(
            String gradeRus,
            String gradeEng,
            String topicRus,
            String topicEng,
    ...
    public static void main(String[] args) throws Exception {
        ...
        ArrayList<AdditionWorksheetsGrade1> additionWorksheetsGrade1 = new ArrayList<>();

        emptyAllFolders();

        //All topics for primary school. Addition in line
        additionWorksheetsGrade1.add( new AdditionWorksheetsGrade1(
                "1 класс.", "Grade 1.",
