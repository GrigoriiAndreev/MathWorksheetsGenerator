package mathpackage.grade6topics;
...
public class AdditionWorksheetsGrade6 extends WorksheetTemplate implements Serializable{
    ...
    public AdditionWorksheetsGrade6(
            String gradeRus,
            String gradeEng,
            String topicRus,
            String topicEng,
    ...
    public static void main(String[] args) throws Exception {
        ...
        ArrayList<AdditionWorksheetsGrade6> additionWorksheetsGrade1 = new ArrayList<>();

        emptyAllFolders();

        //All topics for primary school. Addition in line
        additionWorksheetsGrade1.add( new AdditionWorksheetsGrade6(
                "1 класс.", "Grade 1.",
