...
public class AdditionWorksheetsGrade2 extends WorksheetTemplate implements Serializable{
    ...
    public AdditionWorksheetsGrade2(
            String gradeRus,
            String gradeEng,
            String topicRus,
            String topicEng,
    ...
    public static void main(String[] args) throws Exception {
        ...
        ArrayList<AdditionWorksheetsGrade2> additionWorksheetsGrade1 = new ArrayList<>();

        emptyAllFolders();

        //All topics for primary school. Addition in line
        additionWorksheetsGrade1.add( new AdditionWorksheetsGrade2(
                "1 класс.", "Grade 1.",
