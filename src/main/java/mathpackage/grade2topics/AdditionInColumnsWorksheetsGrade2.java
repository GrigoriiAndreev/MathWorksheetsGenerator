package mathpackage.grade2topics;
...
public class AdditionInColumnsWorksheetsGrade2 extends WorksheetTemplate implements Serializable{
    ...
    public AdditionInColumnsWorksheetsGrade2(
            String gradeRus,
            String gradeEng,
            String topicRus,
            String topicEng,
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<AdditionInColumnsWorksheetsGrade2> additionInColumnWorksheetsGrade1 = new ArrayList<>();

        emptyAllFolders();

        //All topics for primary school. Addition in line
        additionInColumnWorksheetsGrade1.add( new AdditionInColumnsWorksheetsGrade2(
                "1 класс.", "Grade 1.",
