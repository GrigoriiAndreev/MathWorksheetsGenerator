...
public class AdditionInColumnsWorksheetsGrade4 extends WorksheetTemplate implements Serializable{
    ...
    public AdditionInColumnsWorksheetsGrade4(
            String gradeRus,
            String gradeEng,
            String topicRus,
            String topicEng,
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<AdditionInColumnsWorksheetsGrade4> additionInColumnWorksheetsGrade1 = new ArrayList<>();

        emptyAllFolders();

        //All topics for primary school. Addition in line
        additionInColumnWorksheetsGrade1.add( new AdditionInColumnsWorksheetsGrade4(
                "1 класс.", "Grade 1.",
