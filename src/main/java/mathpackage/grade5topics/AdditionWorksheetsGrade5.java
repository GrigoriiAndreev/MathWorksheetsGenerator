package mathpackage.grade5topics;
...
public class AdditionWorksheetsGrade5 extends WorksheetTemplate implements Serializable{
    ...
    public AdditionWorksheetsGrade5(
            String gradeRus,
            String gradeEng,
            String topicRus,
            String topicEng,
    ...
    public static void main(String[] args) throws Exception {
        ...
        ArrayList<AdditionWorksheetsGrade5> additionWorksheetsGrade1 = new ArrayList<>();

        emptyAllFolders();

        //All topics for primary school. Addition in line
        additionWorksheetsGrade1.add( new AdditionWorksheetsGrade5(
                "1 класс.", "Grade 1.",
