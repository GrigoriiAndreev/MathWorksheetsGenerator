...
public class WordsToDigitsWorksheets extends WorksheetTemplate {
    ...
    public static void main(String[] args) throws Exception {
        ...
        wordsToDigitsWorksheets.add(new WordsToDigitsWorksheets(
                "&thinsp;", "&nbsp;",
                "Числа и счет. Написание чисел словами. Числа до 10.", "Counting. Writing numbers in words. Numbers up to 10.",
                "Задачи по математике на тему:<br />Написание чисел словами. Числа до 10. Задачи с ответами. Скачать pdf или jpg.",
                "Mathematics worksheets:<br />Counting. Writing numbers in words. Numbers up to 10. Worksheets with answers. Download pdf or jpg.",
                "", "",
                "Написание чисел словами. Числа до 10.",
                "Writing numbers in words. Numbers up to 10.",
                "Выбери число, которое написано словами.",
        ...
        wordsToDigitsWorksheets.add(new WordsToDigitsWorksheets(
                "&thinsp;", "&nbsp;",
                "Числа и счет. Написание чисел словами. Числа до 100.", "Counting. Writing numbers in words. Numbers up to 100.",
                "Задачи по математике на тему:<br />Написание чисел словами. Числа до 100. Задачи с ответами. Скачать pdf или jpg.",
                ...
                "", "",
                "Написание чисел словами. Числа до 100.",
                "Writing numbers in words. Numbers up to 100.",
                "Выбери число, которое написано словами. Числа до 100.",
        ...
        wordsToDigitsWorksheets.add(new WordsToDigitsWorksheets(
                "&thinsp;", "&nbsp;",
                "Числа и счет. Написание чисел словами. Числа до 1000.", "Counting. Writing numbers in words. Numbers up to 1000.",
                "Задачи по математике на тему:<br />Написание чисел словами. Числа до 1000. Задачи с ответами. Скачать pdf или jpg.",
                ...
                "", "",
                "Написание чисел словами. Числа до 1000.",
                "Writing numbers in words. Numbers up to 1000.",
                "Выбери число, которое написано словами. Числа до 1000.",
