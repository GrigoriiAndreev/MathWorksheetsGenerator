...
public class AdditionWorksheetsGrade3 extends WorksheetTemplate implements Serializable{
    ...
    public AdditionWorksheetsGrade3(
            String gradeRus,
            String gradeEng,
            String topicRus,
            String topicEng,
    ...
    public static void main(String[] args) throws Exception {
        ...
        ArrayList<AdditionWorksheetsGrade3> additionWorksheetsGrade1 = new ArrayList<>();

        emptyAllFolders();

        //All topics for primary school. Addition in line
        additionWorksheetsGrade1.add( new AdditionWorksheetsGrade3(
                "1 класс.", "Grade 1.",
