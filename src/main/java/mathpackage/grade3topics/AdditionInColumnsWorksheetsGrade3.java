package mathpackage.grade3topics;
...
public class AdditionInColumnsWorksheetsGrade3 extends WorksheetTemplate implements Serializable{
    ...
    public AdditionInColumnsWorksheetsGrade3(
            String gradeRus,
            String gradeEng,
            String topicRus,
            String topicEng,
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<AdditionInColumnsWorksheetsGrade3> additionInColumnWorksheetsGrade1 = new ArrayList<>();

        emptyAllFolders();

        //All topics for primary school. Addition in line
        additionInColumnWorksheetsGrade1.add( new AdditionInColumnsWorksheetsGrade3(
                "1 класс.", "Grade 1.",
